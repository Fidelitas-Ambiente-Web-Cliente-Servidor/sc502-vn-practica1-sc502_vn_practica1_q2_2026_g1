...
CREATE TABLE cursos_destacados (
    ...
    badge VARCHAR(30),
    badgeClass VARCHAR(20)
);

INSERT INTO cursos_destacados
(nombre, descripcion, imagen, categoria, badge, badgeClass)
VALUES
(
'Python para Todos',
'Desde cero hasta proyectos reales. Automatización, análisis de datos y programación orientada a objetos.',
...
(
'Full Stack Web',
'HTML, CSS, JavaScript, Node.js y bases de datos relacionales. Conviértete en desarrollador completo.',
...
(
'Machine Learning',
'Redes neuronales, modelos generativos y visión por computadora con Python y TensorFlow.',
...
INSERT INTO cursos
(nombre, categoria, duracion, precio, descripcion, imagen, badge, badge_color)
VALUES
(
'Python para Todos',
'Programación',
'10 semanas',
'$129',
'Desde cero hasta proyectos reales: automatización, programación orientada a objetos y análisis de datos.',
'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=600&q=80',
'Popular',
'accent'
),
...
'12 semanas',
'$149',
'Fundamentos sólidos de Java y POO para crear aplicaciones de escritorio y servicios backend.',
...
'8 semanas',
'$99',
'Pensamiento lógico, complejidad y resolución de problemas para superar entrevistas técnicas.',
...
'10 semanas',
'$159',
'Componentes, hooks y consumo de APIs para construir interfaces modernas, rápidas y mantenibles.',
...
'6 semanas',
'$119',
'Principios de diseño, prototipado en Figma y experiencia de usuario centrada en las personas.',
...
'12 semanas',
'$179',
'Pandas, visualización y estadística aplicada para tomar mejores decisiones basadas en datos.',
